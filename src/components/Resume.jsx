  ...
  return (
    <div id='resume' className='flex flex-col justify-center items-center xsm:p-4 md:pl-20'>
      ...
      <div className='flex flex-col items-center text-center py-8'>
        <p className="mb-8 font-bold text-lg">Click the image below to download my resume:</p>
        <a className='flex flex-col items-center justify-center text-blue-500 font-semibold hover:underline' href={ResumePDF} download="Resume - Mazen Balasta.pdf">
          <div className="relative">
            <img src={resumeImg} alt="image of my resume" className='sm:w-[500px] lg:w-[800px]' />
            <span className="absolute top-0 left-0 w-full h-full bg-blue-500 opacity-0 hover:opacity-25"></span>
          </div>
